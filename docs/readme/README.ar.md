...
*واجهة ChatGPT Vault عند بدء الاستخدام؛ استورد سجلك للبدء.*
...
- تصدير المحادثة بصيغ Markdown وJSON وصورة JPG وPDF، وتصدير المكتبة كاملة كملف `conversations.json` أو ZIP لملفات Markdown أو JSON.
